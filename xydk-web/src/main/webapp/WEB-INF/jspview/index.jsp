      ...
      <section class="envor-section envor-home-slider">
        <div id="layerslider" class="envor-layerslider" style="height: 500px;">
          ...
          <div class="ls-layer" style="transition3d: 1,4,5,11; transition2d: 2,8,30;">
            ...
            <img class="ls-bg" src="img/head22.gif" alt="layer1-background">
          </div>
          <!--LayerSlider layer-->
          <div class="ls-layer" style="transition3d: 2,3,6,14; transition2d: 4,5,23;">
            <!--LayerSlider background-->
            <img class="ls-bg" src="img/head21.gif" alt="layer1-background">
          </div>
        </div>
      <!--
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <h2>小额贷款信息发布平台上线啦！</h2>
              <p>
                           	  我们是一家移动互联网创业公司，我们是一支拥有丰富的互联网行业经验的创业团队。我们崇尚自由、不拘小节，我们关注用户、追求极致，我们充满激情、快速迭代，致力于为用户提供优质的用户体验。
            网络小额贷款也正在成为一种趋势，借助互联网的优势，可以足不出户的完成贷款申请的各项步骤，包括了解各类贷款的申请条件，准备申请材料，一直到递交贷款申请，都可以在互联网上高效的完成。与之相应的，一批网上贷款平台的兴起，也为网上贷款的普及与推广做出了很大的贡献。金融宝p2p网络贷款平台网络贷款就找拍拍贷。
              </p>
              <p>
          ...
          <div class="row" style="margin-top: 0px;">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6" style="margin-top: 0px;">
                <article class="envor-feature">
                  ...
                  <p>2014.11.25—2017年获得国家高新企业认证</p>

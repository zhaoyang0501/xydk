      ...
      <div class="envor-msg envor-msg-info">
          ...
          <div class="row" style="margin-bottom: 30px">
           <div class="col-lg-3 col-md-3">
                ...
                <ul>
                   <li  class=""><i class="glyphicon glyphicon-arrow-right"></i> <a href="center">个人信息</a></li>
                  <li class='active'><i class="glyphicon glyphicon-arrow-right"></i> <a href="mypublish">我的发布</a></li>
          ...
          <div class="col-lg-9 col-md-9">
			  <table class="table table-hover table-bordered">
					 ...
					 <c:forEach items="${publishs }" var="bean">
					 	<tr>
					 		<td>${bean.user.username }</td>
					 		<td><a href="${pageContext.request.contextPath}/viewpublish?id=${bean.id}" > ${bean.title }</a></td>
					 		<td>23</td>
					 		<td>

...
<html>
  ...
  <body>
   ...
   <div class="page-group">
    ...
    <form action="/web/doupdateuser" method="post">
      <ul>
        <!-- Text inputs -->
        <li>
        ...
        <li>
          <div class="item-content">
            ...
            <div class="item-inner">
              ...
              <div class="item-input">
                <input name='email' type="email" placeholder="电子邮箱" value="${user.email }">
              </div>
            </div>
          </div>
        </li>
         <li>
          <div class="item-content">
            ...
            <div class="item-inner">
              ...
              <div class="item-input">
                <input name='tel' type="text" placeholder="手机号码"  value=" ${user.tel }">
              </div>
            </div>
          </div>
        </li>
    ...
    <div class="content-block">
      <div class="row">
        ...
        <div class="col-100"><a href="javascript:void(0)" onclick="fun_submit()" class="button button-big button-fill button-success">确认修改</a></div>
      </div>
    </div>
  </div><!--end content -->

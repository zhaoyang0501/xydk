...
@Controller 
@RequestMapping("book/bookimgupload")
public class NewsImgUploadController extends AbstractFileUploadController{
	...
	public String getFileUploadPath() {
		return uploadpath+File.separator+"book"+File.separator+"img";
	}

	@Override
	public String getFileRelativePath() {
		return "upload"+File.separator+"book"+File.separator+"img";

...
@Controller
@RequestMapping("sys/usersDelete")
public class UsersDeleteController extends AbstractFileUploadController{
	...
	private final List<String>  allowTypes = new ArrayList<String>(){
			private static final long serialVersionUID = -7478928976664848252L;
			{
				 add("xls");
				 add("xlsx");
			 }
